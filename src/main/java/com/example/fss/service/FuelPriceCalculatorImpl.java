...
@Service
@Slf4j
public class FuelPriceCalculatorImpl implements FuelPriceCalculator {
     ...
     *
     * ASSUMPTIONS-1 ::  When the fuellid is open, the filling of fuel at the fuel station will start.
     * Stop filling when lid is closed. Another request for the same city with fuellid open is ignored as fuel is
     * being filled currently for a car in the same city.
     * ASSUMPTION-2 :: When the fuellid is closed that is when the tank is full and we give the bill reading to car.
     * After this,next fuel request from the same city can be processed
     *
     * @param car object
     */
    public void processMessage(Car car) {
